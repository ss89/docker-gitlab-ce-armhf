...
RUN cp /home/git/gitlab/lib/support/init.d/gitlab /etc/init.d/gitlab && cp /home/git/gitlab/lib/support/init.d/gitlab.default.example /etc/default/gitlab && cp /home/git/gitlab/lib/support/nginx/gitlab /etc/nginx/sites-enabled/gitlab && sed -i -e "s/server_name YOUR_SERVER_FQDN;/server_name $HOSTNAME;/" /etc/nginx/sites-enabled/gitlab && rm -f /etc/nginx/sites-enabled/default && mv /home/git/gitlab-shell/config.yml /home/git/gitlab/config/gitlab-shell.yml && ln -s /home/git/gitlab/config/gitlab-shell.yml /home/git/gitlab-shell/config.yml && sed -i -e 's/\$scheme/"https"/' /etc/nginx/sites-enabled/gitlab
